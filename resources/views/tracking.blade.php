...
<main class="tracking-main-wrap">
    ...
    <section class="tracking-search-card">
        <form id="tracking-search-form" class="tracking-form tracking-search-form" autocomplete="off" method="get" action="{{ route('tracking') }}" role="search">
            <input id="trackingInput" name="tracking_number" type="search" value="{{ $searchCode }}" placeholder="Введите трек-код" aria-label="Номер отслеживания" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" data-lpignore="true" data-1p-ignore="true" data-form-type="other">
