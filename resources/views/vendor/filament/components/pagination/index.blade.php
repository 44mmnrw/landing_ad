        ...
        <span class="fi-pagination-overview">
            {{
                trans_choice(
                    ...
                    $paginator->total(),
                    [
                        'first' => number_format((float) ($paginator->firstItem() ?? 0), 0, '.', ' '),
                        'last' => number_format((float) ($paginator->lastItem() ?? 0), 0, '.', ' '),
                        'total' => number_format((float) $paginator->total(), 0, '.', ' '),
                    ],
                )
            }}
        </span>
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        <x-filament::pagination.item
                            ...
                            :aria-label="trans_choice('filament::components/pagination.actions.go_to_page.label', $page, ['page' => number_format((float) $page, 0, '.', ' ')])"
                            :label="number_format((float) $page, 0, '.', ' ')"
